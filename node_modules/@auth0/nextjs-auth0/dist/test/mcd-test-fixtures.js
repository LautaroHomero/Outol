 ...
 */
export const TEST_SECRET = "0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f20";
/**
 * Standard route configuration for testing
 * Matches Auth0 SDK defaults
 */
export const TEST_DEFAULT_ROUTES = {
    login: "/auth/login",
    logout: "/auth/logout",
 ...
 */
export function createTransactionState(partial = {}) {
    return {
 ...
 */
export function createMCDMetadata(domain, issuer) {
 ...
 */
export function createSessionData(partial = {}) {
    return {
        user: { sub: "user_123" },
        tokenSet: {
