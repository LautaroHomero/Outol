...
import { AccessTokenForConnectionOptions, Authenticator, AuthorizationParameters, BackchannelAuthenticationOptions, BackchannelAuthenticationResponse, ChallengeResponse, ConnectionTokenSet, CustomTokenExchangeOptions, CustomTokenExchangeResponse, EnrollmentResponse, EnrollOptions, GetAccessTokenOptions, LogoutStrategy, LogoutToken, MfaVerifyResponse, RESPONSE_TYPES, SessionData, StartInteractiveLoginOptions, TokenSet, VerifyMfaOptions } from "../types/index.js";
...
export declare class AuthClient {
    ...
    private dpopValidated;
    private readonly mfaTokenTtl;
    private proxyDpopHandles;
    /**
     ...
     * @internal
     */
    static readonly MAX_RESPONSE_BODY_SIZE: number;
     ...
     */
    private ensureDpopValidated;
    handler(req: NextRequest): Promise<NextResponse>;
    startInteractiveLogin(options?: StartInteractiveLoginOptions, req?: NextRequest): Promise<NextResponse>;
    ...
    verifyLogoutToken(logoutToken: string): Promise<[null, LogoutToken] | [SdkError, null]>;
     ...
     * @internal
     */
    getSessionWithDomainCheck(cookies: RequestCookies | import("./cookies.js").ReadonlyRequestCookies): Promise<SessionCheckResult>;
    /**
    ...
    connectAccount(options: ConnectAccountOptions & {
        tokenSet: TokenSet;
    }, req?: NextRequest): Promise<[ConnectAccountError, null] | [null, NextResponse]>;
