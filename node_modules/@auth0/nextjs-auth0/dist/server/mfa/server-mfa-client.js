...
export class ServerMfaClient {
    ...
    async challenge(options) {
        const authClient = await this.getAuthClient();
        return authClient.mfaChallenge(options.mfaToken, options.challengeType, options.authenticatorId);
    }
    /**
    ...
    async verify(arg1, arg2, arg3) {
        ...
        if (arg1 instanceof NextRequest) {
            ...
            await authClient.cacheTokenFromMfaVerify(result, arg3.mfaToken, arg1.cookies, arg2.cookies);
            return result;
        }
        else {
            ...
            await authClient.cacheTokenFromMfaVerify(result, arg1.mfaToken, cookies, cookies);
            return result;
        }
    }
}
